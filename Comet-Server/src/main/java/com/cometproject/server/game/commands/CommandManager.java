...
public class CommandManager implements Initialisable {
    ...
    private void loadUserCommands() {
        ...
        this.addCommand(Locale.get("command.setbet.name"), new SetBetCommand());
        this.addCommand(Locale.get("command.warp.name"), new WarpCommand());
        this.addCommand(Locale.get("command.changelog.name"), new ChangelogCommand());
    ...
    private void loadStaffCommands() {
        ...
        this.addCommand("vip", new VIPCommand());
        this.addCommand("lote", new RubyCommand());
