...
public class EventAlertCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] params) {
        ...
        String logDesc;
           ...
           /* discordLog = new TemmieWebhook("https://discordapp.com/api/webhooks/770119574208643093/Unx9HTWUi72czjup3Z-5msEJYe00anCtclwPKT9OFtwQKL1mOQ05dIf_BNxIltgJMT0o");

            DiscordEmbed de = DiscordEmbed.builder()
                    .color(3426654)
                    .title("¡Nuevo evento en HTHOR!") // We are creating a embed with this title...
                    .description("¡Consigue monedas y pásalo en grande, no te lo pierdas!") // with this description...
                    .url("https://www.hthor.com/hotel/" + roomId) // that, when clicked, goes to the TemmieWebhook repo...
                    ...
                    .thumbnail(ThumbnailEmbed.builder() // with a fancy thumbnail...
                            .url("https://swf.hthor.com/swf/c_images/camera/thumbnails/" + roomId + ".png") // with this thumbnail...
                    ...
                    .fields(Arrays.asList( // with fields...
                            FieldEmbed.builder().name("**Juego:**").value("Evento de HTHOR").inline(true).build(),
            ...
            DiscordMessage dm = DiscordMessage.builder()
                    .username("HTHOR Alert") // We are creating a message with the username "Temmie"...
